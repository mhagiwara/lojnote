...
if [ "$1" == "train" ]; then
    ...
    java -jar ldp/maltparser/maltparser-1.9.0.jar -w ldp/data -c ldp-malt -i ldp/data/interim/train.conllx -m learn -a stackeager
elif [ "$1" == "test" ]; then
    python ldp/corpus_reader.py < ldp/data/original/test.dep > ldp/data/interim/test.conllx
    java -jar ldp/maltparser/maltparser-1.9.0.jar -w ldp/data -c ldp-malt -i ldp/data/interim/test.conllx -m parse > ldp/data/interim/test.sys.conllx
